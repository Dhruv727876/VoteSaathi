      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <button
            ...
            className="flex-1 bg-white text-orange-600 border-2 border-orange-600 font-bold py-4 rounded-2xl hover:bg-orange-50 transition-all shadow-lg active:scale-95"
          >
            Share Results 🔗
          </button>
          {gaps.length > 0 && (
            <button
              ...
              className="flex-1 bg-orange-600 text-white font-bold py-4 rounded-2xl hover:bg-orange-700 transition-all shadow-lg shadow-orange-200"
            >
              Fix Gaps with AI 🤖
            </button>
          )}
          <button
            onClick={resetQuiz}
            className="flex-1 font-bold py-4 rounded-2xl border-2 border-gray-200 text-gray-500 hover:bg-gray-50 transition-all"
          >
            Retake
          </button>
        </div>
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="mb-8 flex items-center justify-between px-2">
        <span className="text-sm font-bold text-orange-600 uppercase tracking-wider">Step {step + 1} of 5</span>
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              ...
              className="bg-green-500 text-white font-bold py-6 rounded-2xl hover:bg-green-600 transition-all shadow-lg shadow-green-100 active:scale-95"
            >
            ...
            <button
              ...
              className="bg-red-500 text-white font-bold py-6 rounded-2xl hover:bg-red-600 transition-all shadow-lg shadow-red-100 active:scale-95"
            >
              <div className="text-2xl mb-1">❌</div>
              No / Not Sure
            </button>
